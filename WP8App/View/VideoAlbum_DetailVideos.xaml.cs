...
{
    /// <summary>
    /// Phone application page for VideoAlbum_DetailVideos.
    /// </summary>
    [System.Runtime.CompilerServices.CompilerGenerated]
    [System.CodeDom.Compiler.GeneratedCode("Radarc", "4.0")]
    public partial class VideoAlbum_DetailVideos : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for VideoAlbum_DetailVideos and all its components.
        /// </summary>
        public VideoAlbum_DetailVideos()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaVideoAlbum_DetailVideos0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaVideoAlbum_DetailVideos0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaVideoAlbum_DetailVideos_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaVideoAlbum_DetailVideos(PanoramaVideoAlbum_DetailVideos.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaVideoAlbum_DetailVideos(PanoramaItem panoramaItem)        
        {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Container().Resolve<IvideoAlbum>();
				AddHomeAppBarButton();
				...
				((VideoAlbum_DetailVideosViewModel)DataContext).CurrentYouTubeVideo = pinnedItem;				
			}
