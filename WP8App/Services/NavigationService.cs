...
namespace WPAppStudio.Services
{
    ...
    public class NavigationService : INavigationService
    {
        ...
        {
            { typeof(IAboutIndiaViewModel), "/View/AboutIndia.xaml" },
            { typeof(IVideoAlbum_DetailVideosViewModel), "/View/VideoAlbum_DetailVideos.xaml" },
            { typeof(IPhotoAlbum_DetailViewModel), "/View/PhotoAlbum_Detail.xaml" },
            { typeof(Imonuments_DetailViewModel), "/View/monuments_Detail.xaml" },
            { typeof(IDisclaimer_InfoViewModel), "/View/Disclaimer_Info.xaml" },
        };
