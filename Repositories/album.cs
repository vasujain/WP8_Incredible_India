...
namespace WPAppStudio.Repositories
{
    ...
    public class album : Ialbum 
    {
		...
		private const string RssUrl = "http://api.flickr.com/services/feeds/photos_public.gne?tags=india";

        /// <summary>
        /// Initializes a new instance of the <see cref="album" /> class.
        /// </summary>
        /// <param name="xmlDataSource">A XML based data source.</param>
        public album(IXmlDataSource xmlDataSource)
        {
            _xmlDataSource = xmlDataSource;
        }

        /// <summary>
        /// Retrieves the data from a RSS data source (http://api.flickr.com/services/feeds/photos_public.gne?tags=india), in an observable collection of RssSearchResult items.
        /// </summary>
		...
		/// <summary>
        /// Retrieves the data from a RSS data source (http://api.flickr.com/services/feeds/photos_public.gne?tags=india), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
